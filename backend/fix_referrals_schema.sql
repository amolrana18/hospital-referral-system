-- Fix referrals table schema to match backend implementation
USE hospital_referral_system;

-- Drop the existing referrals table and recreate with correct schema
...
-- Create treatment_updates table (referenced in controller but missing from schema)
